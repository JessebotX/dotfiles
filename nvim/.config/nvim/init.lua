...
--vim.keymap.set('n', '<leader>h', ':bp<CR>', { desc = 'Switch to previous buffer' })
--vim.keymap.set('n', '<leader>l', ':bn<CR>', { desc = 'Switch to next buffer' })

-- Navigate by visual/screen lines normally rather than logical/file lines.
-- If relative line jumps, it moves by logical/file lines instead.
...
require('lazy').setup({
...

    {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap('n', '<A-j>', '<Cmd>BufferPrevious<CR>', opts)
            vim.api.nvim_set_keymap('n', '<A-k>', '<Cmd>BufferNext<CR>', opts)
            vim.api.nvim_set_keymap('n', '<leader>-', '<Cmd>BufferClose<CR>', opts)
            vim.api.nvim_set_keymap('n', '<A-J>', '<Cmd>BufferMovePrevious<CR>', opts)
            vim.api.nvim_set_keymap('n', '<A-K>', '<Cmd>BufferMoveNext<CR>', opts)
